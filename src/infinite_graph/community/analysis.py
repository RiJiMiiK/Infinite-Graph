...
MONO_COMMUNITY_ALGORITHM_EVALUATION: dict[str, dict[str, object]] = {
    ...
    "gdmp2": {
        ...
        "supports_weighted": False,
        "runtime_warning": (
            "GDMP2 stayed fast on small and medium benchmark graphs, but every tested "
            "graph family started failing with RecursionError around 1000 nodes. "
            "Changing min_threshold altered fragmentation on smaller graphs, but did not "
            "remove that large-graph recursion failure."
        ),
        "parameter_definitions": [
            {
                "name": "min_threshold",
        ...
        "weight_value": None,
        "compatibility_note": (
            "Accepts directed input, but the installed CDlib wrapper converts it "
            "internally to an undirected unweighted graph."
        ),
    },
    "girvan_newman": {
        "label": "Girvan-Newman",
